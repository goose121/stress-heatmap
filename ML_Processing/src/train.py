...
from text_encoding import TextVectorizer, load_training_data, export_pipeline_onnx
...
def main():
    ...
    PIPELINE_PATH = 'models/Model_v2.onnx'  # combined model
    ...
    # Export combined pipeline as ONNX
    # Produces one .onnx file: string input -> predicted label
    # No separate vectorizer file needed - both steps are baked in.
    export_pipeline_onnx(vectorizer_wrapper, model, PIPELINE_PATH)
